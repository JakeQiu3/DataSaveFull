...
- (void)initData {
    _dataArray = [[NSArray alloc] initWithObjects:@"文件存储 之 偏好设置",@"文件存储 之 归档",@"文件存储 之 plist文件（xml属性列表）",@"数据库存储 之 sqlite（嵌入式数据库）",@"数据库存储 之 FMDB",@"数据库存储 之 Core Data（面向对象方式的嵌入式数据库）", nil];
